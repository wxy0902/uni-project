			...
			<view @click="jump(item.id)">
				<view class="post-item">
					<view class="post-item-top-user">
						...
						<text style="font-size:10px">{{item.create_time}}</text>
					</view>
						...
						<block v-if="item.type == 1">
							...
							<block v-if="item.media.length == 2">
								<view class="img-style-2">
									<image :lazy-load="true" v-for="(mediaItem, index2) in item.media" :key="index2" @click="previewImage(mediaItem,item.media)"
