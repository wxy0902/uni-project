...
/***/ 138:
/*!*************************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/main.js?{"page":"pages%2Flogin%2Flogin"} ***!
  \*************************************************************************************************************/
...
/***/ 139:
/*!******************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/pages/login/login.vue ***!
  \******************************************************************************************/
/*! no static exports found */
...
/***/ 140:
/*!*************************************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \*************************************************************************************************************************/
...
/***/ 142:
/*!*******************************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/pages/login/login.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _MessageServer = __webpack_require__(/*! @/api/MessageServer.js */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
...

{
  ...
  methods: {
    // 登录提交
    fnLogin: function fnLogin() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var rsaRes, accountRes, userinfoRes, mesRes, signinRes;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
                ...
                // 进行登录
                _this.isLogin = true;_context.prev = 4;_context.next = 7;return (

                  (0, _CommonServer.getRsaText)("".concat(_this.mobile, ",").concat(_this.password)));case 7:rsaRes = _context.sent;_context.next = 10;return (

                  (0, _UserServer.loginByPhone)(rsaRes.data));case 10:accountRes = _context.sent;
                _this.$store.commit('user/setAccountInfoData', accountRes.data.Data);
                uni.setStorageSync('TOKEN', accountRes.data.Data.AccessToken);
                // 保存登录用户信息
                _context.next = 15;return (0, _UserServer.getUserInfo)(accountRes.data.Data.UserID);case 15:userinfoRes = _context.sent;
                _this.$store.commit('user/setUserInfoData', userinfoRes.data.Data);
                // 获取未读消息数
                _context.next = 19;return (0, _MessageServer.getMessageNoReadCount)();case 19:mesRes = _context.sent;
                _this.$store.commit('setNewsCountData', mesRes.data.Data);
                // 获取签到信息
                _context.next = 23;return (0, _HanbiServer.getSigninInfo)();case 23:signinRes = _context.sent;
                _this.$store.commit('setSigninInfoData', signinRes.data.Data);

                // 开始调整主页
                _this.isLogin = false;
                uni.reLaunch({
                  url: '/pages/index/index?current=0' });_context.next = 32;break;case 29:_context.prev = 29;_context.t0 = _context["catch"](4);


                _this.isLogin = false;case 32:case "end":return _context.stop();}}}, _callee, null, [[4, 29]]);}))();

    },
    // 跳转页面
    fnPage: function fnPage(type) {
      if (this.isLogin) return;
      uni.navigateTo({
        url: "/pages/".concat(type, "/").concat(type) });

    },
    // 调起微信登录
    fnWechat: function fnWechat() {
      if (this.isLogin) return;
      console.log('微信登录');
      uni.showLoading({
        title: '微信登录' });
...
/***/ 144:
/*!***************************************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/pages/login/login.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
