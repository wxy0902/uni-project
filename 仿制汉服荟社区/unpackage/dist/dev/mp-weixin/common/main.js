...
/***/ 0:
/*!****************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/main.js ***!
  \****************************************************************************/
...
var IIcon = function IIcon() {__webpack_require__.e(/*! require.ensure | components/i-icon/i-icon */ "components/i-icon/i-icon").then((function () {return resolve(__webpack_require__(/*! @/components/i-icon/i-icon */ 328));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
_vue.default.component('i-icon', IIcon);
// 用户头像组件
var UserAvatar = function UserAvatar() {__webpack_require__.e(/*! require.ensure | components/user-avatar/user-avatar */ "components/user-avatar/user-avatar").then((function () {return resolve(__webpack_require__(/*! @/components/user-avatar/user-avatar */ 335));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
_vue.default.component('user-avatar', UserAvatar);
// 下拉刷新组件
var MescrollUni = function MescrollUni() {Promise.all(/*! require.ensure | components/mescroll-uni/mescroll-uni */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/mescroll-uni/mescroll-uni")]).then((function () {return resolve(__webpack_require__(/*! @/components/mescroll-uni/mescroll-uni.vue */ 340));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
...
/***/ 10:
/*!*****************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/App.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************/
/*! no static exports found */
...
var _MessageServer = __webpack_require__(/*! @/api/MessageServer.js */ 19);var _default =
...

{
  onLaunch: function onLaunch() {var _this = this;
    ...
    if (!!token) {
      ...
      // 启动封面
      (0, _CommonServer.getStarCover)().then(function (coverRes) {
        // 保存启动封面
        _this.$store.commit('common/setStarCoverData', coverRes.data.Data);
        // 取得rsa加密文本
        return (0, _CommonServer.getRsaText)("".concat(token, ",").concat(Math.floor(new Date().getTime() / 1000)));
      }).then(function (rsaRes) {
        // 刷新token值 
        return (0, _UserServer.refreshUserToken)(rsaRes.data);
        ...
        // 获得登录用户信息
        return (0, _UserServer.getUserInfo)(accountRes.data.Data.UserID);
      }).then(function (userinfoRes) {
        // 保存登录用户信息
        _this.$store.commit('user/setUserInfoData', userinfoRes.data.Data);
        // 获取未读消息数
        return (0, _MessageServer.getMessageNoReadCount)();
      }).then(function (mesRes) {
        // 保存未读消息数
        _this.$store.commit('setNewsCountData', mesRes.data.Data);
        // 获取签到信息
        return (0, _HanbiServer.getSigninInfo)();
...
/***/ 20:
/*!*************************************************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/App.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 9:
/*!****************************************************************************!*\
  !*** /Users/wangxinyao/Documents/HBuilderProjects/project/仿制汉服荟社区/App.vue ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
